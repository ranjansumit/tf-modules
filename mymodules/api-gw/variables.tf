...
variable "method_variables" {
    ...
    default = {
        ...
        method6={http_method="POST",resource="producer",resource_path="pplusproducer",authorization="COGNITO_USER_POOLS",api_key_required=false,authorization_scopes="https://pplus-service/RestCreateProducerAccess",cache_key_parameters="",connection_id="",connection_type="",integration_http_method="POST",passthrough_behavior="",type="AWS_PROXY",uri="LAMBDA_ARN",request_parameters_key="" ,request_parameters_value=""},
